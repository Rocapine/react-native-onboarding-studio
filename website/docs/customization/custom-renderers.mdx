...
- **Just need colors/fonts?** → Use [Level 1: Theming](./theming.mdx)
- **Just need button styles?** → Use [Level 2: Custom Components](./custom-components.mdx)
- **Want animations?** → Try [Level 2: Custom Components](./custom-components.mdx) with custom lists
...
- 🎨 [**Theming**](./theming.mdx) - Use theme tokens in your custom renderers
- 🔧 [**Custom Components**](./custom-components.mdx) - Combine with component customization
- 📘 [**API Reference**](../api-reference.mdx) - Full step type reference
- 🎭 [**Page Types**](../page-types.mdx) - Understand all step types
